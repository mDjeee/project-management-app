...
export const SORT_TASK_BY_ORDER = '[Sort] Task By Order';
...
export class SortTaskByOrder implements Action {
  readonly type = SORT_TASK_BY_ORDER;
  constructor(public payload: { columnId: string, tasks: Task[]}) { }
}
